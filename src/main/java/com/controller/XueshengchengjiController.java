    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(xueshengchengji !=null){
            ...
            //级联表 课程
            //级联表
            KechengEntity kecheng = kechengService.selectById(xueshengchengji.getKechengId());
            if(kecheng != null){
    ...
    */
    ...
    public R save(@RequestBody XueshengchengjiEntity xueshengchengji, HttpServletRequest request){
        ...
        Wrapper<XueshengchengjiEntity> queryWrapper = new EntityWrapper<XueshengchengjiEntity>()
            ...
            .eq("kecheng_id", xueshengchengji.getKechengId())
            ;
...
//                            xueshengchengjiEntity.setKechengId(Integer.valueOf(data.get(0)));   //课程 要改的
//                            xueshengchengjiEntity.setXueshengchengjiDefen(data.get(0));                    //得分 要改的
