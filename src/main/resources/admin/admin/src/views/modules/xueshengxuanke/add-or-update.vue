    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='kecheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="截止报名时间" prop="jiezhiTime">
                        <el-input v-model="kechengForm.jiezhiTime"
                                  placeholder="截止报名时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="截止报名时间" prop="jiezhiTime">
                            <el-input v-model="ruleForm.jiezhiTime"
                                      placeholder="截止报名时间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xueshengxuankeYesnoTypes" label="申请状态" prop="xueshengxuankeYesnoTypes">
                        <el-input v-model="ruleForm.xueshengxuankeYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xueshengxuankeYesnoText" label="审核意见" prop="xueshengxuankeYesnoText">
                        <span v-html="ruleForm.xueshengxuankeYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xueshengxuankeShenheTime" label="审核时间" prop="xueshengxuankeShenheTime">
                        <span v-html="ruleForm.xueshengxuankeShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    kechengId: false,
                    insertTime: false,
                    xueshengxuankeYesnoTypes: false,
                    xueshengxuankeYesnoText: false,
                    xueshengxuankeShenheTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    kechengId: '',
                    insertTime: '',
                    xueshengxuankeYesnoTypes: '',
                    xueshengxuankeYesnoText: '',
                    xueshengxuankeShenheTime: '',
                },
                xueshengxuankeYesnoTypesOptions : [],
                kechengOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengxuanke_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengxuankeYesnoTypesOptions = data.data.list;
                    }
                });
