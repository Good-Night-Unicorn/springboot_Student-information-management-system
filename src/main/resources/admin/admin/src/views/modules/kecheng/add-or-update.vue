        ...
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengFile" label="课程附件" prop="kechengFile">
                        <file-upload
                                tip="点击上传课程附件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="课程附件" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.kechengFile"  >课程附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="截止报名时间" prop="jiezhiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiezhiTime" label="截止报名时间" prop="jiezhiTime">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengFile: [
                              { required: true, message: '课程附件不能为空', trigger: 'blur' },
                          ],
                   kechengTypes: [
                   ...
                   jiezhiTime: [
                              { required: true, message: '截止报名时间不能为空', trigger: 'blur' },
                          ],
                   kechengContent: [
