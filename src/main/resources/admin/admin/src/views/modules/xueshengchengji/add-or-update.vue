    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="kechengId" name="kechengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="得分" prop="xueshengchengjiDefen">
                       <el-input v-model="ruleForm.xueshengchengjiDefen"
                                 placeholder="得分" clearable  :readonly="ro.xueshengchengjiDefen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="得分" prop="xueshengchengjiDefen">
                           <el-input v-model="ruleForm.xueshengchengjiDefen"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评分缘由" prop="xueshengchengjiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xueshengchengjiContent" label="评分缘由" prop="xueshengchengjiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xueshengchengjiContent: [
                              { required: true, message: '评分缘由不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
